        ...
        with st.chat_message("assistant"):
            with st.spinner("Thinking..."):
                ...
                response = ai_engine.generate_response(
                    prompt,
                    get_enhanced_prompt(st.session_state.current_subject, prompt, context)
                )
