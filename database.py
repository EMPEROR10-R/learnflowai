...
class Database:
    ...
    def _create_tables(self):
        # FIX: Removed SQL line comments (--) which caused the "near EXISTS: syntax error"
...
Please replace the content of your `database.py` file with the code above and try running your Streamlit application again. This should resolve the database initialization error.
